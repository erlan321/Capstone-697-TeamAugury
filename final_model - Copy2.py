...
# Uncomment to generate features and save data to csv (~10 minutes)
  ...
  feature_df = pd.read_csv("saved_work/backup_features_data_to_April18.csv")
...
classifier = SVC(kernel='rbf', probability=True, random_state=rnd_state, C=0.25, gamma=0.015625)
clf = Pipeline(steps=[('preprocessor', preprocessor), ('classifier', classifier)])
clf.fit(X,y)
#filename = "models/"+ classifier.__class__.__name__ + "_final_model.pkl"
filename = "models/"+ classifier.__class__.__name__ + "_model_C_0_25_g_0_015625.pkl"

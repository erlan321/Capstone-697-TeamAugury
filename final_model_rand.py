...
classifier = SVC(kernel='sigmoid', probability=True, random_state=rnd_state, C=5.646714110605624, gamma= 0.001078182828286456)
clf = Pipeline(steps=[('preprocessor', preprocessor), ('classifier', classifier)])
clf.fit(X,y)
filename = "models/"+ classifier.__class__.__name__ + "_final_model_rand.pkl"
